 ...
 */
public class UnUpsScanListAdapter extends RecyclerView.Adapter<AbsViewHolder> {
    private Context mContext;
    private ArrayList<UpstorageItemBean> mData = new ArrayList<>();

    public UnUpsScanListAdapter(Context context, ArrayList<UpstorageItemBean> mData) {
    ...
    class NRKViewHolder extends AbsViewHolder {
        ...
        public void fillView(Object o) {
            ...
            if (o instanceof UpstorageItemBean) {
                ...
                tmpTest.append("未上架数：").append(bean.getUnUpNum());
